...
const props = defineProps(["id", "selected", "file", "current_id", "duration"]);
////////////////////////////////////////////.
		...
		>
			<div class="content">
				<div class="card" style="width: 18rem; text-align: center">
					<div class="card-body">
						<p class="card-title">{{ getMixinValue.lang.file }}</p>
						<div class="mt-2">
							<a href="https://file-examples.com/storage/fecbba2e0c66800b6a18e9c/2017/10/file-sample_150kB.pdf" class="btn sg-btn-primary triger_btn"
								><i class="las la-file-pdf"></i>Pdf</a
							>
						</div>
					</div>
				</div>
