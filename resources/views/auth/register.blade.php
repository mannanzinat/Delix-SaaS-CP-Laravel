        ...
        <div class="container">
            <div class="row justify-content-center align-items-center min-vh-100">
                <div class="col-lg-6 col-md-8 col-sm-12 position-relative">
                    <img src="{{ static_asset('admin/assets/img/shape/rect.svg') }}" alt="Rect Shape"
                        class="bg-rect-shape">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="company" value="{{ old('company') }}" class="form-control @error('company') is-invalid @enderror"
                                    id="company" placeholder="{{ __('enter_your_company_name') }}">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="last_name" value="{{ old('last_name') }}"
                                        class="form-control" placeholder="{{ __('enter_your_last_name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="address" placeholder="{{ __('enter_your_address') }}">{{ old('address') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="phone_number" value="{{ old('phone_number') }}"
                                    class="form-control @error('phone_number') is-invalid @enderror" id="last_name" id="phone_number" placeholder="{{ __('enter_your_phone') }}"
                                >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror"
                                    id="email" placeholder="{{ __('enter_your_email') }}">
                                @if ($errors->has('email'))
                                    <div class="invalid-feedback help-block">
                            ...
                            <div class="custom-checkbox mb-20">
                                <label>
                                    ...
                                    <span>
                                        {{ __('i_agree') }}
                                        <a tabindex="-1" target="_blank" href="{{ url('/privacy-policy') }}">{{ __('privacy_policy') }}</a> &amp;
