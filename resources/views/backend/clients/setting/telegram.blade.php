										...
										<div class="mb-4">
											...
											<div class="input-group">
												<input type="text"
												       ...
												       name="access_token" class="form-control @if (!empty(@Auth::user()->client->telegramSetting->access_token)) disabled @endif" id="access_token_input"
											...
											<div class="p-2">
												@if (!empty(@Auth::user()->client->telegramSetting->access_token) && !empty(@Auth::user()->client->telegramSetting->scopes))
