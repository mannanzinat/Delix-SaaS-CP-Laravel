                ...
                <li>
                    <a class="dropdown-item" href="{{ $route }}" style="text-align: left">
                        <div class="notification-content">
                            <img class="user-avater" src="{{ optional($notification->createdBy->image)->image_small_two ? asset(optional($notification->createdBy->image)->image_small_two) : getFileLink('80X80', []) }}">
