                ...
                <ul class="d-flex align-items-center gap-lg-4 gap-sm-2">
                    ...
                    <li class="dropdown pe-lg-20">
                        <a href="#" class="dropdown-toggle d-flex gap-12" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img class="user-avater" src="{{ optional(\Sentinel::getUser()->image)->image_small_one ? asset(optional(\Sentinel::getUser()->image)->image_small_one) : getFileLink('80X80', []) }}" class="redious-border">
                            <span
