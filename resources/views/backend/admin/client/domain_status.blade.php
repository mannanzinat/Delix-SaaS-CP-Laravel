 <div class="d-flex text-center gap-1">
    ...
    <label for="deployed_script" class="custom-control-label pt-2 pb-4 w-100">
        <input type="checkbox" class="custom-control-input read common-key pb-4" name="deployed_script" value="1" id="deployed_script">
