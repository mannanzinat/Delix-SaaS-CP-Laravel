    ...
    <div class="main-content-wrapper">
        <section class="oftions">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="section-title">{{__('update_server') }}</h3>
                        <form action="{{ route('cloud-server.update', $server->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2" id="ip"
                                                   name="ip" value="{{ $server->ip}}" placeholder="{{ __('ip') }}" required>
                                            @if ($errors->has('ip'))
                                                <div class="nk-block-des text-danger">
                                                    <p>{{ $errors->first('ip') }}</p>
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control rounded-2" id="user_name"
                                                   name="user_name" value="{{ $server->user_name }}" placeholder="{{ __('user_name') }}" required>
