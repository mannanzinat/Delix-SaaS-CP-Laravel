...
@section('content')
	<section class="oftions">
		<div class="container-fluid">
			<form @if (setting('is_stripe_activated')) action="{{ route('client.stripe.redirect', ['trx_id' => $trx_id, 'payment_type' => 'stripe', 'package_id' => $package->id]) }}"
			      @endif
			      @if (setting('is_paypal_activated')) action="{{ route('client.paypal.redirect', ['trx_id' => $trx_id, 'payment_type' => 'paypal', 'package_id' => $package->id]) }}"
			      @endif
			      @if (setting('is_paddle_activated')) action="{{ route('client.paddle.redirect', ['trx_id' => $trx_id, 'payment_type' => 'paddle', 'package_id' => $package->id]) }}"
			      @endif
