                        ...
                        <div class="selected-files d-flex flex-wrap gap-20">
                            <div class="selected-files-item">
                                <img class="selected-img"
                                 src="{{ optional(\Sentinel::getUser()->image)->image_small_two ? asset(optional(\Sentinel::getUser()->image)->image_small_two) : getFileLink('80X80', []) }}"
                                 alt="favicon">
                            </div>
                        </div>
                    </div>
                ...
                <form
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 input_file_div">
                            ...
                            <div class="selected-files d-flex flex-wrap gap-20">
                                <div class="selected-files-item">
                                    <img class="selected-img" src="{{ $merchant['trade_license'] ? asset($merchant['trade_license']) : getFileLink('80X80', []) }}" alt="favicon">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 input_file_div">
                            ...
                            <div class="selected-files d-flex flex-wrap gap-20">
                                <div class="selected-files-item">
                                    <img class="selected-img" src="{{ $merchant['nid'] ? asset($merchant['nid']) : getFileLink('80X80', []) }}"
                                    alt="favicon">
                                </div>
                            </div>
                        </div>
