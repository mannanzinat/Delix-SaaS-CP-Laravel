        ...
        <div class="tab-pane active" id="personal">
            <div class="gy-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="contact_number" class="form-control" value="{{ old('contact_number') ? old('contact_number') : $shop->contact_number}}" id="contact_number" placeholder="{{__('contact_number')}}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="shop_phone_number" class="form-control" value="{{ old('shop_phone_number') ? old('shop_phone_number') : $shop->shop_phone_number}}" id="shop_phone_number" placeholder="{{__('pickup_number')}}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control">{{ old('address') ? old('address') : $shop->address }}</textarea>
