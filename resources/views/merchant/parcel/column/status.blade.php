<div>
    ...
    @elseif($parcel->status == 'pickup-assigned')
        <span class="badge {{ config('parcel_status.' . $parcel->status . '.color') }}">{{ __('pickup-assigned') }}</span><br>
    ...
    <div class="d-lg-none d-flex">
        ...
        @if ($parcel->status == 'pending' || $parcel->status == 'pickup-assigned' || $parcel->status == 're-schedule-pickup')
            ...
            <div class="tb-odr-btns d-md-inline mr-1">
                <a href="javascript:void(0);"
                    ...
                    data-original-title="{{ __('deleted') }}"
                    id="delete-parcel" data-bs-toggle="modal"
                    data-bs-target="#parcel-delete"><i
        ...
        @if (
            ...
            <div class="tb-odr-btns d-md-inline mr-1">
                <a href="javascript:void(0);"
                    class="cancel-parcel btn btn-sm btn-danger btn-tooltip textr-light"
                    data-original-title="{{ __('cancel') }}"
                    id="cancel-parcel" data-bs-toggle="modal"
                    data-bs-target="#parcel-cancel"><i
        ...
        @if ($parcel->status == 'cancel')
            <div class="tb-odr-btns d-md-inline mr-1">
                <a href="javascript:void(0);"
                    ...
                    id="parcel-re-request" data-bs-toggle="modal"
                    data-bs-target="#re-request-parcel"><i
