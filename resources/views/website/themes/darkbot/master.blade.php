...
<html lang="{{ systemLanguage() ? systemLanguage()->locale : 'en' }}"
    ...
    <head>
		...
		<!-- font awesome -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/all.min.css')}}" />
		<!-- bootstraph -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/bootstrap.min.css')}}" />
		<!-- Swiper js -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/swiper-bundle.min.css')}}" />
		<!-- FancyBox -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/jquery.fancybox.min.css')}}" />
		<!-- Animate Animation -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/animate.css')}}" />
		<!-- User's CSS Here -->
		<link rel="stylesheet" href="{{ static_asset('website/themes/darkbot/assets/css/style.css')}}" />
        @stack('css')

	</head>
	<body>
            @include('website.themes.darkbot.layouts.header')
		@yield('content')
            @include('website.themes.darkbot.layouts.footer')
		<!-- JS -->
		<script src="{{ static_asset('website/themes/darkbot/assets/js/jquery-3.6.0.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/bootstrap.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/smooth-scroll.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/gsap.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/jquery.fancybox.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/swiper-bundle.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/wow.min.js')}}"></script>
		<script src="{{ static_asset('website/themes/darkbot/assets/js/scripts.js')}}"></script>
