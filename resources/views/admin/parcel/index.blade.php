                    ...
                    <div class="oftions-content-right mb-12 filterOPT">
                        ...
                        @if(hasPermission('parcel_create'))
                            @if(@settingHelper('preferences')->where('title','create_parcel')->first()->staff)
                                <a href="{{route('import.csv')}}" class="d-flex align-items-center btn btn-sm sg-btn-primary gap-2"><i class="icon las la-plus"></i><span>{{__('import')}}</span></a>
                            @endif
                        @endif
                        ...
                        @if(hasPermission('parcel_create'))
                            @if(@settingHelper('preferences')->where('title','create_parcel')->first()->staff)
                                <a href="{{route('parcel.create')}}" class="d-flex align-items-center btn btn-sm sg-btn-primary gap-2"><i class="icon las la-plus"></i><span>{{__('create').' '.__('parcel')}}</span></a>
                            @else
