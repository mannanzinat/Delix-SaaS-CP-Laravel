                                    ...
                                    <table class="table">
                                        <tbody class="nk-data data-list">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ $merchant->trade_license }}">
                                                        <span class="tb-status text-success">{{ $merchant->trade_license ? __('trade_license') : __('not_available') }}
                                                            @php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ $merchant->nid }}">
                                                        <span class="tb-status text-info">{{ $merchant->nid ? __('nid') : __('not_available') }}
                                                            @php
                                                                if ($merchant->nid != '') {
                                                                    echo '<i class="icon  las la-external-link-alt"></i>';
                                                                }
