                            ...
                            <div class="col-md-4">
                                <div class="card-inner">
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="fv-full-name">{{__('last_name')}}  <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-12 input_file_div">
                                            ...
                                            <div class="selected-files d-flex flex-wrap gap-20">
                                                <div class="selected-files-item">
                                                    <img class="selected-img" src="{{ $staff->image ? asset($staff->image->original_image) : getFileLink('80X80', []) }}"
                                                    alt="favicon">
                                                </div>
                                            </div>
                                        </div>
