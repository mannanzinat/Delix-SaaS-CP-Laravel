                    ...
                    <form action="{{ route('general.setting') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row gx-20">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                                ...
                                <input type="text" class="form-control rounded-2 @error('activation_code') is-invalid @enderror" id="activation_code" name="activation_code"
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                                ...
                                <input type="text" name="default_weight" class="form-control rounded-2 @error('default_weight') is-invalid @enderror" id="default_weight"
