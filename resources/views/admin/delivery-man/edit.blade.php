                            ...
                            <div class="col-md-12">
                                <div class="card-inner">
                                    <div class="row g-gs">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="pick_up_fee">{{ __('pick_up_fee') }} ({{ setting('default_currency') }})
                                                    <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="delivery_fee">{{ __('delivery_fee') }} ({{ setting('default_currency') }})
                                                    <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="delivery_fee">{{ __('return_fee') }} ({{ setting('default_currency') }})
                                                    <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-4 input_file_div">
                                            ...
                                            <div class="selected-files d-flex flex-wrap gap-20">
                                                <div class="selected-files-item">
                                                    <img class="selected-img" src="{{ $delivery_man['driving_license'] ? asset($delivery_man['driving_license']) : getFileLink('80X80', []) }}"
                                                    alt="favicon">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="selected-files d-flex flex-wrap gap-20">
                                                <div class="selected-files-item">
                                                    <img class="selected-img"
                                                            src="{{ optional($delivery_man->user->image)->original_image ? asset(optional($delivery_man->user->image)->original_image) : getFileLink('80X80', []) }}"
                                                            alt="favicon">
                                                </div>
                                            </div>
                                        </div>
