                ...
                <div class="user-info-panel align-items-center d-flex gap-3 justify-content-center mb-3">
                    <div class="users-img">
                        @if(!blank($user->image) && file_exists($user->image->image_small_two))
                            <img src="{{static_asset($user->image->image_small_two)}}" alt="{{$user->first_name}}" class="redious-border">
                        @else
                        <img src="{{static_asset('admin/images/default/user40x40.jpg')}}" alt="{{$user->first_name}}" class="redious-border">
                        @endif
                    </div>
                    <div class="user-info">
