                                ...
                                <form action="{{ route('staff.change-password') }}" class="form-validate" method="POST"
                                    ...
                                    <div class="gy-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="new_password" class="form-control" id="full-new_password"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="confirm_new_password" class="form-control"
                                                id="full-confirm_new_password" placeholder="{{ __('confirm_new_password') }}" required>
                                        </div>
