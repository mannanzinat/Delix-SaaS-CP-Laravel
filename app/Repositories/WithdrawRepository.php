...
class WithdrawRepository implements WithdrawInterface {
    ...
    public function store($request)
    {
        ...
        try{
            ...
            if($sms_template->sms_to_merchant):
                $this->test($sms_body, $withdraw->merchant->phone_number, 'payment_create_event', setting('active_sms_provider'), $sms_template->masking);
            endif;
    ...
    public function update($request)
    {
        ...
        try{
            ...
            if($sms_template->sms_to_merchant):
                $this->test($sms_body, $withdraw->merchant->phone_number, 'payment_update_event', setting('active_sms_provider'), $sms_template->masking);
            endif;
            //merchant sms end
    ...
    public function chargeStatus($id, $status)
    {
        ...
        try{
            ...
            if($sms_template->sms_to_merchant):
                $this->test($sms_body, $merchant_withdraw->merchant->phone_number, 'payment_cancelled_event', setting('active_sms_provider'), $sms_template->masking);
            endif;
            //merchant sms end
