...
use App\DataTables\SasAdmin\ClientDataTable;
use App\Http\Controllers\Controller;
use App\Repositories\SasAdmin\UserRepository;
use Brian2694\Toastr\Facades\Toastr;
use Illuminate\Support\Facades\Gate;
use App\Repositories\SasAdmin\ClientRepository;
use App\Repositories\SasAdmin\CountryRepository;
use App\Http\Requests\SasAdmin\ClientRequest;
use App\Http\Requests\SasAdmin\ClientUpdateRequest;
...
class ClientController extends Controller
{
    ...
    public function index(ClientDataTable $dataTable)
    {
        try {
            ...
            return $dataTable->render('sas.client.all_client', $data);
    ...
    public function create()
    {
        try {
            ...
            return view('sas.client.add_client', $data);
        } catch (Exception $e) {
            Toastr::error('something_went_wrong_please_try_again');
            return back();
        }
    ...
    public function edit($id): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            ...
            return view('sas.client.edit_client', $data);
        } catch (Exception $e) {
            Toastr::error('something_went_wrong_please_try_again');
            return back();
        }
    ...
    public function payment($id): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            ...
            return view('sas.client.payout.payout_method', $data);
        } catch (Exception $e) {
            Toastr::error('something_went_wrong_please_try_again');
